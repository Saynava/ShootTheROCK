...
- Saved local time: 2026-04-18 21:52:37
- Scene: Assets/Scenes/SampleScene.unity
- Unity version: 6000.4.0f1
- Purpose: compact but inspectable current-state snapshot for agent follow-up work
- Detailed canonical diff file: `Assets/_Game/UI/ShootTheRockSceneStateSnapshot.flat.txt`
- Human-readable change report: `Assets/_Game/UI/ShootTheRockSceneStateChanges.md`
- Project summary: `Assets/_Game/UI/ShootTheRockProjectStateSummary.md`
- Restore snapshot used by Restore: `Assets/_Game/UI/ShootTheRockRestoreSnapshot.json`

## Snapshot coverage
- Tracked roots: 3
- GameObjects captured: 20
- Components captured: 59
- Serialized property lines captured: 572
- Total flat records: 731
